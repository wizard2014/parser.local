...
//            ],
        ...
        'guards' => [
            ...
            \BjyAuthorize\Guard\Controller::class => [
                ...
                ['controller' => 'Ebay\Controller\Listener', 'action' => ['index'], 'roles' => ['guest','user']],
                ...
                ['controller' => 'User\Controller\Settings', 'action' => ['index', 'profile', 'notification', 'statistics', 'subscription', 'download', 'get-file', 'remove-user'], 'roles' => ['guest', 'user']],
...
//                    'roles' => ['staffer', 'admin'],
            ...
            \BjyAuthorize\Guard\Route::class => [
                ...
                ['route' => 'settings/default', 'roles' => ['guest', 'user']],
                // forgot password
...
//                ['route' => 'console', 'roles' => ['guest', 'user']],
                ...
                ['route' => 'listener', 'roles' => ['guest', 'user']],
            ],
        ],
    ],
];